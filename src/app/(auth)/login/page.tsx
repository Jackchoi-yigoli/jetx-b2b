    ...
    <>
      ...
      <div className="auth-form">
        <div className="form-group">
          ...
          <input type="email" className="form-input" placeholder={t('emailPlaceholder')} />
        </div>
        <div className="form-group">
      ...
      <button className="btn btn-primary btn-lg btn-block">{t('signIn')}</button>
      ...
      <p className="auth-bottom-text">
        {t('noAccount')}{' '}
        <span style={{ color: 'var(--color-text-muted)' }}>{t('contactAdmin')}</span>
      </p>
    </>
  );
}
